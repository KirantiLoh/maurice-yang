...
const HeroSection = () => {
  ...
  return (
    <section ref={containerRef} style={{opacity: scale >= 150 ? "0" : "1"}} className='px-10 sm:px-16 md:px-28 transition-opacity duration-700 pt-20 relative w-full h-[200vh] overflow-y-auto z-[1]'>
        ...
        <aside className='flex flex-col gap-3 fixed max-w-full top-1/2 -translate-y-1/2 z-[1]'>
          <h1 className='text-xl sm:text-2xl text-primary'>Maurice Yang • 楊理森</h1>
          ...
          <div className="flex flex-wrap items-center">
            ...
            <a target="_blank" rel="noreferrer" className='px-6 py-3 text-lg rounded-lg w-max' href="https://drive.google.com/file/d/1TC-qISk-5d8Pmcb7U-_HN7oh3Jfi4ESE/view?usp=share_link">View Resume</a>
          </div>
        </aside>
    </section>
  )
